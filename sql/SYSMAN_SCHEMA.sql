...
CREATE TABLE SYSMAN.ODT(
  ...
  KEY k_ODT_EQUIPO_KEY(equipo_id),
  KEY k_ODT_RUTINA_KEY(rutina_id),
  KEY k_ODT_USUARIO_KEY(usuario_id),
  KEY k_ODT_UNIDAD_EQUIPO_KEY(unidad_equipo_id),
  KEY k_ODT_ODT_ESTATUS_KEY(odt_estatus_id),
  CONSTRAINT fk_ODT_EQUIPO FOREIGN KEY (equipo_id) REFERENCES SYSMAN.Equipo(id),
  CONSTRAINT fk_ODT_RUTINA FOREIGN KEY (rutina_id) REFERENCES SYSMAN.Rutina(id),
  CONSTRAINT fk_ODT_USUARIO FOREIGN KEY (usuario_id) REFERENCES SYSMAN.Usuario(id),
  CONSTRAINT fk_ODT_UNIDAD_EQUPO FOREIGN KEY (equipo_id) REFERENCES SYSMAN.Unidad_Equipo(id),
  CONSTRAINT fk_ODT_ODT_ESTATUS FOREIGN KEY (odt_estatus_id) REFERENCES SYSMAN.Odt_estatus(id)
